...
type
  ...
  TMainForm = class(TForm)
    ...
    procedure Closeparsontools1Click(Sender: TObject);
...
resourcestring
  ...
  rsHex = 'Hex';
  rsDoYouWantToGoToTheparsontoolsWebsite =
  ...
  rsBringsparsontoolsToFront = 'brings '+strCheatEngine+' to front';
...
begin
  ...
  if InputQuery(rsparsontools, rsWhatWillBeTheNewNameForThisTab, s) then
...
begin
  ...
  begin
    ...
    if wikiurl='' then //no wikilink given
      HtmlHelpA(Win32WidgetSet.AppHandle, PChar(cheatenginedir + 'parsontools.chm'), HH_HELP_CONTEXT, Data)
    else
    {$endif}
...
begin
  ...
  if messagedlg(rsDoYouWantToGoToTheparsontoolsWebsite, mtConfirmation,
    [mbYes, mbNo], 0) = mrYes then
...
begin
  ...
  begin
    ...
    fronttext := rsBringsparsontoolsToFront;
...
procedure TMainForm.Closeparsontools1Click(Sender: TObject);
begin
  Close;
end;
...
begin
  ShellExecute(0,'open','https://wiki.parsontools.org/index.php',nil,nil,SW_SHOW);
