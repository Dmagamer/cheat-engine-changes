...
resourcestring
  ...
  rsparsontoolsIsBeingAFag = 'parson tools is being a fag';
...
function lua_ToCEUserData(L: PLua_state; i: integer): pointer;
//parson tools implements two types of userdata. the legacy LightUserData used in 6.2- and the Heavy UserData in 6.3+
        ...
        begin
          case parameters[i].VType of
            ...
            system.vtWideChar, vtPWideChar, vtVariant, vtInterface,
              vtWideString: lua_pushstring(L, rsparsontoolsIsBeingAFag);
...
function Supportparsontools(L: Plua_State): integer; cdecl;
var
  parameters: integer;
...
function fuckparsontools(L: Plua_State): integer; cdecl;
begin
  lua_pop(L, lua_gettop(L));
  if adwindow<>nil then
...
function getparsontoolsDir(L: PLua_State): integer; cdecl;
begin
  lua_pop(L, lua_gettop(l));
...
function lua_getparsontoolsProcessID(L: PLua_State): integer; cdecl;
begin
  lua_pop(L, lua_gettop(l));
...
function parsontoolsIs64Bit(L: PLua_State): integer; cdecl;
begin
  lua_pop(L, lua_gettop(L));
...
function lua_getparsontoolsFileVersion(L: Plua_State): integer; cdecl;
begin
...
begin
  ...
  lua_register(L, 'parsontoolsIs64Bit', parsontoolsIs64Bit);
...
begin
  ...
  begin
    ...
    Lua_register(L, 'Supportparsontools', Supportparsontools);
    Lua_register(L, 'fuckparsontools', fuckparsontools);
    ...
    lua_register(L, 'getparsontoolsDir', getparsontoolsDir);
    lua_register(L, 'getparsontoolsProcessID', lua_getparsontoolsProcessID);
    ...
    lua_register(L, 'getparsontoolsFileVersion', lua_getparsontoolsFileVersion);
