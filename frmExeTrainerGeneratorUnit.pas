      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              addfile(cheatenginedir+'parsontools-i386.exe');
              ...
              begin
                ...
                addfile(cheatenginedir+'parsontools-i386.exe.sig');
              end;
            ...
            begin
              addfile(cheatenginedir+'parsontools-x86_64.exe');
              ...
              begin
                addfile(cheatenginedir+'dbk64.sys');
                addfile(cheatenginedir+'parsontools-x86_64.exe.sig');
              end;
