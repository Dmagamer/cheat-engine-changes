...
resourcestring
  ...
  rsThisWillAttachTheDebuggerOfparsontoolsToTheCurrent = 'This will attach the debugger of '+strCheatEngine+' to the current process.';
...
begin
  ...
  begin
    ...
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:=rsThisWillAttachTheDebuggerOfparsontoolsToTheCurrent+' '+rsDoNotCloseCE
    else
    {$endif}
      mes:=rsThisWillAttachTheDebuggerOfparsontoolsToTheCurrent+' '+rsContinue;
