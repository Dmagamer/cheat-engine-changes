...
var
  ...
  i: integer;
begin
  add_include_path(s,{$ifdef standalonetest}'/Users/ericheijnen/Documents/GitHub/cheat-engine//bin/parsontools-x86_64.app/Contents/MacOS/'+{$endif}'include');
  {$ifdef windows}
  add_include_path(s,{$ifdef standalonetest}'D:\git\cheat-engine\\bin\'+{$endif}'include\winapi');
  {$endif}
  add_include_path(s,{$ifdef standalonetest}'/Users/ericheijnen/Documents/GitHub/cheat-engine//bin/parsontools-x86_64.app/Contents/MacOS/'+{$endif}'include\sys');
