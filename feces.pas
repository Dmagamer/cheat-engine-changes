unit feces;
//friends endorsing parson tools system
...
resourcestring
  ...
  rsSelectYourparsontoolsSignatureFile = 'Select your '+strCheatEngine+' signature '
    +'file';
  rsparsontoolsSignatureFiles = strCheatEngine+' signature files';
  ...
  rsFailedToLoadparsontoolsPublicKey = 'Failed to load '+strCheatEngine+' public key';
    ...
    begin
      ...
      begin
        ...
        if not succeeded(s) then raise exception.create(
          rsFailedToLoadparsontoolsPublicKey);
      end;
...
begin
  ...
  begin
    ...
    try
      od.Title:=rsSelectYourparsontoolsSignatureFile;
      od.Filter:=rsparsontoolsSignatureFiles+'|*.CESIG';
