...
begin
  ...
  begin
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:='This will attach the debugger of parson tools to the current process. If you close parson tools while the game is running, the game will close too. Are you sure you want to do this?'
    else
      mes:='This will attach the debugger of parson tools to the current process. Continue?';
...
//        attaching:=false;
        ...
        err:='parson tools failed to create the process. (Error='+pchar(IntToStr(GetLastError))+')';
        messagebox(0,pchar(err),'Create failure',mb_ok);
  ...
  //    }
      ...
      begin
        ...
        {$ifndef net}
        err:='parson tools failed to attach to the process. (Error='+IntToStr(GetLastError)+')';
        ...
        case devent.dwDebugEventCode of
          ...
          begin
            ...
            begin
              ...
              begin
                //check if this is a exception breakpoint that was made by parson tools
                      ...
                      try
                        ...
                        begin
                          ...
                          begin
                            ...
                            j:=devent.dwThreadId;
                            if not WaitForDebugEvent(devent,10000) then application.MessageBox('userbreakpoint bug','parson tools Debugger',0);
