...
resourcestring
  ...
  rsTutorialStep6=
    ...
    'Go back to the main parson tools window (you can keep this extra info window open if you want, but if you close it, '+
    ...
    ''+#13#10+
    'extra:'+#13#10+
    'You could also use the pointer scanner to find the pointer to this address. https://parsontools.org/help/pointer-scan.htm';
