...
begin
  {$ifdef windows}
  ShellExecute(0, PChar('open'), PChar('https://parsontools.org/tutorial.php?tutorial='+ftutorialtag),PChar(''), PChar(''), SW_SHOW);
  {$else}
  OpenURL('https://parsontools.org/tutorial.php?tutorial='+ftutorialtag);
  {$endif}
end;
