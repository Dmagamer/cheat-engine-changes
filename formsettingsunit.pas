...
resourcestring
  ...
  rsPopupHideparsontools = 'Popup/Hide '+strCheatEngine;
...
begin
  ...
  begin
    n:=f[i];
    if not (fileexists(n+pathsep+'parsontools.po') or fileexists(n+PathDelim+'parsontools-x86_64.po') or fileexists(n+PathDelim+'parsontools-i386.po')) then
      continue;
